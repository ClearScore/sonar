...
class Dependency {
    ...
    registerParent({ version, type, pkg, workspacePackage }) {
        ...
        const newIsGtMin = !version.startsWith('workspace:')
            && !this.minVersion.startsWith('workspace:')
            && semver.gt(semver.minVersion(version), semver.minVersion(this.minVersion));
